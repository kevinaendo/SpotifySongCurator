                    ...
                    req.onload = function (genre) {
                        ...
                        if (seedArtists.length > 0) {
                            ...
                            req2.onload = function () {
                                ...
                                document.getElementById('song_info').innerHTML = '<iframe id = "play_button" src="' + url + '" width="400" height="450" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>';
                                ...
                                document.getElementById('yes').addEventListener('click', function () {
                                    ...
                                    document.getElementById('song_info').innerHTML =
                                        '<iframe id = "play_button" src="' + url + '"width="400" height="450" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>';
                                    i = i + 1;
                                });
